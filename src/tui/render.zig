...
//! so callers keep using `render.drawX` / `render.endLine` / etc.
//!
...
pub const drawSoundfontEditor = soundfont.drawSoundfontEditor;
...
pub const drawSoundfontStatus = status.drawSoundfontStatus;
