...
pub const SynthParamAutomationSnap = persist_types.SynthParamAutomationSnap;
pub const NoteSnap = persist_types.NoteSnap;
...
pub const CompSnap = persist_types.CompSnap;
pub const MultibandCompSnap = persist_types.MultibandCompSnap;
pub const OttSnap = persist_types.OttSnap;
pub const DelaySnap = persist_types.DelaySnap;
pub const ReverbSnap = persist_types.ReverbSnap;
pub const legacy_eq_band_count = persist_types.legacy_eq_band_count;
pub const EqBandKindSnap = persist_types.EqBandKindSnap;
pub const EqStereoModeSnap = persist_types.EqStereoModeSnap;
pub const EqBandSnap = persist_types.EqBandSnap;
pub const EqSnap = persist_types.EqSnap;
...
pub const ChorusSnap = persist_types.ChorusSnap;
pub const PhaserSnap = persist_types.PhaserSnap;
pub const FlangerSnap = persist_types.FlangerSnap;
pub const TapeSnap = persist_types.TapeSnap;
pub const FreqShiftSnap = persist_types.FreqShiftSnap;
pub const FilterSnap = persist_types.FilterSnap;
pub const LimiterSnap = persist_types.LimiterSnap;
pub const UtilitySnap = persist_types.UtilitySnap;
pub const StereoWidthSnap = persist_types.StereoWidthSnap;
pub const AutoPanSnap = persist_types.AutoPanSnap;
pub const TransientShaperSnap = persist_types.TransientShaperSnap;
pub const FxSnap = persist_types.FxSnap;
pub const FxKind = persist_types.FxKind;
pub const ClapSnap = persist_types.ClapSnap;
pub const Vst3Snap = persist_types.Vst3Snap;
pub const FxUnitSnap = persist_types.FxUnitSnap;
pub const InstrumentKind = persist_types.InstrumentKind;
pub const SamplerSnap = persist_types.SamplerSnap;
pub const SlicerSnap = persist_types.SlicerSnap;
pub const SoundfontSnap = persist_types.SoundfontSnap;
pub const RackSnap = persist_types.RackSnap;
pub const TrackSnap = persist_types.TrackSnap;
pub const SendSnap = persist_types.SendSnap;
pub const GroupSnap = persist_types.GroupSnap;
pub const ClipKind = persist_types.ClipKind;
pub const ClipSnap = persist_types.ClipSnap;
pub const LaneSnap = persist_types.LaneSnap;
pub const SectionSnap = persist_types.SectionSnap;
pub const Snapshot = persist_types.Snapshot;
pub const save = persist_save.save;
pub const rackToSnap = persist_save.rackToSnap;
pub const clapToSnap = persist_save.clapToSnap;
pub const vst3ToSnap = persist_save.vst3ToSnap;
pub const snapFromDevice = persist_save.snapFromDevice;
pub const chainToSnap = persist_save.chainToSnap;
pub const exportSamples = persist_save.exportSamples;
pub const pruneOrphanSamples = persist_save.pruneOrphanSamples;
pub const writeSampleWav = persist_save.writeSampleWav;
pub const writeSampleBytes = persist_save.writeSampleBytes;
pub const joinWsjRel = persist_save.joinWsjRel;
pub const isSafeWsjRel = persist_save.isSafeWsjRel;
pub const notesToSnap = persist_save.notesToSnap;
pub const clipToSnap = persist_save.clipToSnap;
pub const automationToSnap = persist_save.automationToSnap;
...
pub const restoreSamples = persist_load.restoreSamples;
pub const readWsjRel = persist_load.readWsjRel;
pub const sampleName = persist_load.sampleName;
pub const finiteClamp = persist_load.finiteClamp;
pub const buildSession = persist_load.buildSession;
pub const loadClapState = persist_load.loadClapState;
pub const loadVst3State = persist_load.loadVst3State;
pub const midiToNoteSnaps = persist_load.midiToNoteSnaps;
pub const applyNoteSnap = persist_load.applyNoteSnap;
pub const legacyStepVel = persist_load.legacyStepVel;
pub const legacyPatternVelToMidi = persist_load.legacyPatternVelToMidi;
pub const clipFromSnap = persist_load.clipFromSnap;
pub const applySynthParamAutomationSnap = persist_load.applySynthParamAutomationSnap;
pub const replaceSynthParamPoints = persist_load.replaceSynthParamPoints;
...
pub const loadNotes = persist_load.loadNotes;
pub const isValidFxOrder = persist_load.isValidFxOrder;
...
pub const migrateSynthFx = persist_load.migrateSynthFx;
pub const clearMigratedSynthFx = persist_load.clearMigratedSynthFx;
pub const fxKindOwnsParam = persist_load.fxKindOwnsParam;
pub const applySynthPatch = persist_load.applySynthPatch;
pub const applyLegacyFx = persist_load.applyLegacyFx;
