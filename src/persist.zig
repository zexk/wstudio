...
fn synthToSnap(s: *const PolySynth) SynthSnap {
    return .{
        ...
        .osc_c_on = s.osc_c_on,
        .osc_c_waveform = s.osc_c_waveform,
        .osc_c_pulse_width = s.osc_c_pulse_width,
        .osc_c_semi = s.osc_c_semi,
        .osc_c_detune_cents = s.osc_c_detune_cents,
        .osc_c_level = s.osc_c_level,
