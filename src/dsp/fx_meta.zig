...
pub const effect_specs = [_]EffectSpec{
    ...
    .{ .label = "CROSSOVER",  .editor_title = "CROSSOVER",      .strip_label = "XOVR", .badge_label = "xov",  .category = "TONE",       .description = "Split, gain, and solo three frequency bands",  .display_label = "BAND GAIN" },
