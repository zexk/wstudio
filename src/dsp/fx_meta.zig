...
pub const effect_specs = [_]EffectSpec{
    ...
    .{ .label = "CROSSOVER",  .editor_title = "CROSSOVER",      .strip_label = "XOVR", .badge_label = "xov",  .category = "TONE",       .description = "Split, gain, and solo three frequency bands",  .display_label = "RESPONSE" },
    ...
    .{ .label = "UTILITY",    .editor_title = "UTILITY",        .strip_label = "UTIL", .badge_label = "utl",  .category = "UTILITY",    .description = "Gain, delay, channels, and test noise",         .display_label = "LOUDNESS" },
    ...
    .{ .label = "AMP",        .editor_title = "GUITAR AMP",     .strip_label = "AMP",  .badge_label = "amp",  .category = "CHARACTER",  .description = "Three amp voicings, tone stack, and speaker cabinet", .display_label = "RESPONSE" },
