...
pub const effect_specs = [_]EffectSpec{
    ...
    .{ .label = "AMP",        .editor_title = "GUITAR AMP",     .strip_label = "AMP",  .badge_label = "amp",  .category = "CHARACTER",  .description = "Preamp, tone stack, and speaker cabinet",    .display_label = "SHAPER" },
