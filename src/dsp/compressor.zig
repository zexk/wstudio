...
pub const Compressor = struct {
    ...
    pub fn handleEvent(self: *Compressor, ev: dsp.Event) void {
        switch (ev) {
            ...
            .note_on, .note_off, .all_off, .cc, .pitch_bend, .midi2_cc, .midi2_pitch_bend, .set_param, .set_param_abs, .set_mod_target, .automation_param, .clap_param, .vst3_param, .capture_pad => {},
        }
    }
