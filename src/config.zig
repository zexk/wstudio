...
pub const GuiTheme = config_options.GuiTheme;
pub const TuiTheme = config_options.TuiTheme;
pub const PanelBorder = config_options.PanelBorder;
pub const PathBuf = config_options.PathBuf;
pub const Config = config_options.Config;
pub const Frontend = config_options.Frontend;
pub const Scope = config_options.Scope;
pub const option_specs = config_options.option_specs;
const setOption = config_options.setOption;
const getOption = config_options.getOption;
