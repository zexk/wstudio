...
pub const param_value_queue_iid: Tuid = official.Steinberg_Vst_IParamValueQueue_iid;
pub const parameter_changes_iid: Tuid = official.Steinberg_Vst_IParameterChanges_iid;
