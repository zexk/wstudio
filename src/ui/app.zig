...
pub const App = struct {
    ...
    pub fn resetForNewSession(self: *App) void {
        ...
        self.last_edit = .none;
        self.piano_grab = false;
        self.piano_stamp = false;
        self.drum_stamp = false;
        self.arr_stamp = false;
        self.piano_grab_delta = .{};
        self.piano_mouse_draw = false;
        self.piano_erase_active = false;
        self.piano_clone_source = null;
        self.piano_mouse_grab_offset = 0;
        self.drum_paint_state = null;
        self.slicer_paint_state = null;
        self.arr_drag_bar = null;
        self.arr_drag_resize = false;
        self.arr_drag_clone = false;
        self.arr_drag_clone_done = false;
        self.sampler_drag_marker = null;
        self.sampler_drag_window = false;
        self.sampler_drag_norm = 0;
        self.automation_mouse_edit = false;
        self.automation_mouse_erase = false;
        self.fx_drag_slot = null;
        self.piano_visual_anchor = null;
        self.drum_visual_anchor = null;
        self.slicer_visual_anchor = null;
        self.arr_visual_anchor = null;
        self.automation_visual_anchor = null;
        self.piano_visual_pitch_anchor = null;
        self.drum_visual_pad_anchor = null;
        self.slicer_visual_slice_anchor = null;
        self.arr_visual_lane_anchor = null;
        self.piano_visual_edit = false;
        self.drum_visual_edit = false;
        self.slicer_visual_edit = false;
        self.piano_op_pending = null;
        self.drum_op_pending = null;
        self.slicer_op_pending = null;
        self.arr_op_pending = null;
        self.automation_op_pending = null;
        self.pending_prefix = null;
        self.pending_prefix_count = 0;
        self.keymap_pending_len = 0;
        self.macro_pending = .none;
        self.macro_pending_count = 1;
        self.tracks_del_pending = false;
        self.tracks_visual_anchor = null;
